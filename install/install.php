...
function step_01_checkEvironment()
{
    ...
    ### check db-setting exists ###
    {
        ...
        elseif (file_exists('../' . confGet('DIR_SETTINGS') . 'db_settings.inc.php')) {
            ...
            if (!rename(
                '../' . confGet('DIR_SETTINGS') . 'db_settings.inc.php',
            ...
            if ($sql_obj->execute("SELECT * FROM {$f_db_table_prefix}db 
                ...
                */
                ...
                if ($db_version < confGet('STREBER_VERSION')) {
                    ...
                    return $result;
                } elseif ($streber_version_required > confGet('STREBER_VERSION')) {
