...
class Page
{
    ...
    * add a page function
    */
    public function add_function(PageFunction $fn)
    {
        global $PH;
    ...
    public function print_presets($args = null)
    {
...
class PageHeader extends PageElement
{
    ...
    private function PageHeaderAsHTML()
    {
        ...
        } elseif (confGet('REGISTER_NEW_USERS')) {
            $buffer .= '<div id="user_functions">'
                   . '<span class="features">'
...
class PageHeaderNavigation extends PageElement
{
    public function __toString()
    {
        ...
        foreach ($this->page->crumbs as $l) {
            ...
            elseif ($l->target_id == $this->page->cur_crumb) {
                $l->active = true;
                $active_navi_link = $l;
                ...
                break;
            } elseif ($l->target_id == $PH->cur_page_id) {
                $l->active = true;
                if ($active_navi_link) {
    ...
    public function __toString()
    {
        ...
        if ($view != 'GUEST') {
            ...
            if (confGet('LIST_UNDEFINED_LANG_KEYS')) {
                global $g_lang_new;
                if (isset($g_lang_new)) {
                    echo '<b>undefined language keys:</b><br/>';
