...
class ListBlockColMethod extends ListBlockCol
{
    public function render_tr(&$obj, $style = '')
    {
        ...
        if ($this->style) {
            echo "<td class='$this->style'>$out</td>";
        } else {
            echo "<td>$out</td>";
        }
    }
...
class ListBlockColTime extends ListBlockCol
{
    ...
    public function render_tr(&$obj, $style_overwrite = '')
    {
        if (!isset($obj) || !is_object($obj)) {
        ...
        echo "<td class='$this->style $style_overwrite'>$format</td>";
    }
}
...
class ListBlockColDate extends ListBlockCol
{
    ...
    public function render_tr(&$obj, $style = '')
    {
        ...
        echo "<td class='nowrap'>$value_str</td>";
    }
}
