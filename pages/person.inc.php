...
function personList()
{
    ...
    ### get preset-id ###
    {
        ...
        } elseif ($tmp_preset_id = get('STREBER_personList_preset')) {
            if (isset($presets[$tmp_preset_id])) {
                $preset_id = $tmp_preset_id;
            }
        }
...
function personViewProjects()
{
    ...
    ### get preset-id ###
    {
        ...
        } elseif ($tmp_preset_id = get('STREBER_personViewProjects_preset')) {
            if (isset($presets[$tmp_preset_id])) {
                $preset_id = $tmp_preset_id;
            }
        }
...
function personViewTasks()
{
    ...
    ### get preset-id ###
    {
        ...
        } elseif ($tmp_preset_id = get('STREBER_personViewTasks_preset')) {
            if (isset($presets[$tmp_preset_id])) {
                $preset_id = $tmp_preset_id;
            }
        }
...
function personViewEfforts()
{
    ...
    ### get preset-id ###
    {
        ...
        } elseif ($tmp_preset_id = get('STREBER_personViewEfforts_preset')) {
            if (isset($presets[$tmp_preset_id])) {
                $preset_id = $tmp_preset_id;
            }
        }
...
function personViewChanges()
{
    ...
    ### get preset-id ###
    {
        ...
        } elseif ($tmp_preset_id = get('STREBER_personViewChanges_preset')) {
            if (isset($presets[$tmp_preset_id])) {
                $preset_id = $tmp_preset_id;
            }
        }
...
function personEditSubmit()
{
    ...
    if ($effort_style = get('person_effort_style')) {
        ...
        } elseif ($effort_style == EFFORT_STYLE_DURATION) {
