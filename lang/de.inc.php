...
'Go to your home. Alt-h / Option-h' => 'Persönliche Übersicht. Alt-h / Option-h',
'<span class=accesskey>P</span>rojects' => '<span class=accesskey>P</span>rojekte',
'Your projects. Alt-P / Option-P' => 'Ihre Projekte. Alt-P / Option-P',
'People' => 'Personen',
'Your related People' => 'Für Sie relevante Personen',
'Companies' => 'Firmen',
'Your related Companies' => 'Für Sie relevante Firmen',
'Calendar' => 'Kalender',
'<span class=accesskey>S</span>earch:&nbsp;' => '<span class=accesskey>S</span>uchen:&nbsp;',
'Click Tab for complex search or enter word* or Id and hit return. Use ALT-S as shortcut. Use `Search!` for `Good Luck`' => 'Begriff eingeben und Bestätigen. Erweiterte Suche durch anklicken des Tabs.',

'Wiki+Help' => 'Wiki+Hilfe',
'Documentation and Discussion about this page' => 'Hilfe und Diskussion zu diesem Bereich von Streber',
'This page requires java-script to be enabled. Please adjust your browser-settings.' => 'Bitte aktivieren Javascript, damit Sie Streber benutzen können.',
'you are' => 'Sie sind',

'How this page looks for clients' => 'So würde diese Seite für Kunden aussehen',
...
'Company' => 'Firma',
'Project' => 'Projekt',
'Select lines to use functions at end of list' => 'Markieren Sie Zeilen für die Funktionen am Ende der Liste',
'Priority' => 'Priorität',
'Edit' => 'Bearbeiten',
'Log hours for a project' => 'Aufwände erfassen',
'Create new project' => 'Neues Projekt erstellen',
'You have no open tasks' => 'Sie haben keine offenen Aufgaben',
'Open tasks' => 'Offene Aufgaben',
'Task-Status' => 'Status der Aufgabe',
'Folder' => 'Ordner',
'Started' => 'Begonnen',
'Est.' => 'ges.',
'Estimated time in hours' => 'Geschätzter Aufwand in Stunden',
'status->Completed' => 'Status->erledigt',
'status->Approved' => 'Status->abgenommen',
'status->Closed' => 'Status->geschlossen',
'Delete' => 'Löschen',
'Log hours for select tasks' => 'Aufwände für Aufgabe buchen',
'%s tasks with estimated %s hours of work' => '%s Aufgaben mit mit ca. %s Stunden',
...
'Intra' => 'Intra',
'Mail' => 'E-Mail',
' Hint: for already existing projects please edit those and adjust company-setting.' => ' Tip: Zuweisung bereits existierender Projekte müssen am Projekt vorgenommen werden..',
...
'Please consider that activating login-accounts might trigger security-issues.' => 'Bitte berücksichtigen Sie, Benutzerkonten ein potentielles Risiko darstellen.',
...
'<b>NOTE</b>: Some projects are hidden from your view. Please ask an administrator to adjust you rights to avoid double-creation of projects' => 'Hinweis: Einige Projekte sind für Sie nicht sichtbar. Zur Vermeidung von doppelt erstellten Projekten, sollten Sie sich mit Ihren Administrator absprechen.',
...
'Add person as team-member to project' => 'Person zu einem Projekt hinzufügen',
...
'The changed profile <b>does not affect existing project roles</b>! Those has to be adjusted inside the projects.' => 'Das geänderte Profil hat keinen Einfluss auf aktuelle Projektrollen. Diese müssen einzeln angepasst werden.',
...
'No|As in... >No< Comments' => 'Keine',
'visible as %s' => 'Sichtbar als %s',
'Current Milestone' => 'Aktueller Meilenstein',
'%s completed task' => '%s Aufgabe fertig',
'%s needs approval' => '%s Aufgabe zur Abnahme',
'%s need approval' => '%s Aufgaben zur Abnahme',
'Please login' => 'Bitte melden Sie sich an',
'Project News' => 'Projekt News',
'%s by %s|time ago by nickname' => 'vor %s von %s',
'Also show yours|E.i. also show your changes' => 'Auch deine Änderungen zeigen',
'Hide yours|E.i. Filter out your changes' => 'Deine Änderungen ausblenden',
'%s project|links to project in recent changes list' => '%s Projekt',
'Remove many items' => 'Viele Objekte löschen',
'Preview removed items' => 'Vorschau für gelöschte Objekte',
'Project overview' => 'Projekt Überblick',
'This project does not have any text yet.\nDoubleclick here to add some.' => 'Dieses Projekt hat noch keine Beschreibung.',
'<b>%s</b> is not a valid value for start time.' => '<b>%s</b> ist keine gültige Startzeit.',
'<b>%s</b> is not a valid value for end time.' => '<b>%s</b> ist keine gültige Endzeit.',
'<b>%s</b> is not a valid value for hours.' => '<b>%s</b> ist kein gültiger Wert für Stunden.',
'Only comments that look like spam' => 'Nur Kommentare, die nach Spam aussehen.',
'Following items will be removed' => 'Die folgenden Objekte werden gelöscht',
'Untitled' => 'Unbenannt',
'Removed %s items' => '%s Objekte löschen',
'Created %s %s with ID %s|Created <type> <name> with ID <id>...' => '%s %s erstellt als %s',
'Open milestone' => 'Offener Meilenstein',
'This task does not have any text yet.\nDoubleclick here to add some.' => 'Diese Aufgabe hat noch keine Beschreibung.',
'Attach new file' => 'Neue Datei anhängen',
'Hello %s. Welcome to project %s' => 'Hallo %s. Willkommen bei %s',
'Updates at %s|notification mail subject' => 'Neues bei %s',
'Thanks for your time|notification' => 'Danke für deine Zeit.',
'the management|notification' => 'Die Verwaltung',
'Please use the following link to' => 'Klicke diesen Link,',
'Please use the following link to update your account settings:' => 'Klicke diesen Link, um Deine Einstellungen zu bearbeiten:',
