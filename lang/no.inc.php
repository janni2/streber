...
'Go to your home. Alt-h / Option-h' => 'Personlig oversikt. Alt-h / Option-h',
'<span class=accesskey>P</span>rojects' => '<span class=accesskey>P</span>rosjekter',
...
'Your related Companies' => 'Dine relevante organisasjoner',
'Calendar' => 'Kalender',
'<span class=accesskey>S</span>earch:&nbsp;' => '<span class=accesskey>S</span>øk:&nbsp;',
'Click Tab for complex search or enter word* or Id and hit return. Use ALT-S as shortcut. Use `Search!` for `Good Luck`' => 'Tast inn begrep og bekreft. Utvidet søk gjennom å klikke på flik.',

#--- header --------------------------------------------------------------
'Wiki+Help' => 'Wiki+Hjelp',
'Documentation and Discussion about this page' => 'Hjelp og diskusjon omkring dette tema i programmet',
'This page requires java-script to be enabled. Please adjust your browser-settings.' => 'Vennligst aktiver Javascript for å kunne benytte programmet.',
'you are' => 'Du er',

'How this page looks for clients' => 'Slik vil siden se ut for kunden',
...
'Project' => 'Prosjekt',
'Select lines to use functions at end of list' => 'Marker linjer for å benytte funksjoner på slutten av listen',
'Priority' => 'Prioritet',
'Edit' => 'Redigere',
'Log hours for a project' => 'Logge timer',
'Create new project' => 'Opprette nytt prosjekt',
'You have no open tasks' => 'Du har ingen åpne oppgaver',
'Open tasks' => 'Åpne oppgaver',
'Task-Status' => 'Oppgave status',
'Folder' => 'Mappe',
'Started' => 'Påbegynt',
'Est.' => 'Ber.',
'Estimated time in hours' => 'Beregnet tidsforbruk i timer',
'status->Completed' => 'Status->Ferdig',
'status->Approved' => 'Status->Godkjent',
'Delete' => 'Slette',
'Log hours for select tasks' => 'Logg timer for oppgave',
'%s tasks with estimated %s hours of work' => '%s oppgaver med ca. %s timers arbeid',
...
'Intra' => 'Intra',
'Mail' => 'E-Post',
' Hint: for already existing projects please edit those and adjust company-setting.' => ' Tips: For allerede eksisterende projekter foretas endringer der..',
...
'Please consider that activating login-accounts might trigger security-issues.' => 'Vær oppmerksom på at bruker konti representerer potensiell sikkerhets risiko.',
...
'<b>NOTE</b>: Some projects are hidden from your view. Please ask an administrator to adjust you rights to avoid double-creation of projects' => 'Bem: Noen prosjekter er ikke synlig for deg. For å unngå dobbelregistrering av prosjekter burde du snakke med administrator.',
...
'Add person as team-member to project' => 'Legg Person til Prosjekt',
...
'HINT: You turned task <b>%s</b> into a folder. Folders are shown in the task-folders list.' => 'Du har gjort <b>%s</b> om til en mappe. Mapper vises kun i oppgave treet.',
...
'Operation aborted with an fatal data-base structure error (%s). This may have happened do to an inconsistency in your database. We strongly suggest to rewind to a recent back-up. Please help us by %s' => 'Operasjon avbrutt med fatal database struktur feil (%s). Dette kan ha skjedd pga inkonsekvens i din database. Vi anbefaler sterkt å ta inn en backup. Vennligst hjelp oss ved %s',
...
'Due to limitations of MySQL fulltext search, searching will not work for...<br>- words with 3 or less characters<br>- Lists with less than 3 entries<br>- words containing special charaters' => 'Søk fungerer kun for<br>- Ord med mer enn 3 bokstaver<br>- Lister med mer enn 3 registreringer<br>- Ord uten spesialtegn',
...
'Turned parent task into a folder. Note, that folders are only listed in tree' => 'Endret oppgaven til en mappe. Disse blir kun vist i trevisningen.',
...
'Operation aborted with an fatal data-base structure error (%s). This may have happened do to an inconsistency in your database. We strongly suggest to rewind to a recent back-up.' => 'Operasjonen ble avbrutt pga feil i datastrukturen. Det kan være tegn på inkonsistent Databankstruktur. Bør vurderes å ta sikkerhetskopi eller ta inn siste backup.',
...
'If you remember your name, please enter it and try again.' => 'Om du husker brukernavnet ditt kan du taste det inn og forsøke omigjen.',
'Supposed a user with this name existed a notification mail has been sent.' => 'Dersom denne brukeren finnes ble det sendt en e-post.',
'Welcome %s. Please adjust your profile and insert a good password to activate your account.' => 'Velkommen %s. Vennligst aktualiser profilen din og tast inn et bra passord.',
'Sorry, but this activation code is no longer valid. If you already have an account, you could enter your name and use the <b>forgot password link</b> below.' => 'Feil: denne aktiveringskoden er ikke lenger gyldig. Eventuelt ble passordet endret i mellomtiden...',
...
'Since nicknames are case sensitive using uppercase letters might confuse users at login.' => 'Da det skilles mellom store og små bokstaver i brukernavn kan noen brukere bli forvirret.',
'<b>%s</b> has been assigned to projects and can not be deleted. But you can deativate his right to login.' => '<b>%s</b> er allerede tildelt Projekter og kan defor ikke slettes. Konto for innlogging kan derimot deaktiveres.',
...
### ../lists/list_projectchanges.inc   ###
'Other team members changed nothing since last logout (%s)' => 'Ingen endringer siden siste innlogging (%s)',
...
'A notification / activation  will be mailed to <b>%s</b when you log out.' => 'En melding blir sendt til %s så snart du logger av.',
...
'Sending an activation mail does not make sense, until the user is allowed to login. Please adjust his profile.' => 'Aktiveringsmail har ingen hensikt sålenge Personen ikke får logge inn. Vennligst se over Profil.',
...
'Account settings for user (do not confuse with project rights)' => 'Rettigheter for Person (Ikke å forveksle med rettigheter for bestemte prosjekter).',
...
### ../pages/person.inc   ###
'A notification / activation  will be mailed to <b>%s</b> when you log out.' => 'En aktiverings e-post blir sendt til <b>%s</b> så snart du logger ut.',
...
'with this automatically created e-mail we want to inform you that|notification' => 'Vil med denne meldingen informere om at',
'since %s' => 'siden %s',
...
'If you do not want to get further notifications or you forgot your password feel free to|notification' => 'Ønsker du ikke flere e-poster, eller har glemt passord',
...
### ../db/db_item.inc.php   ###
'Unknown' => 'Ukjent',
'Item has been modified during your editing by %s (%s minutes ago). Your changes can not be submitted.' => 'Objektet ble endret av  %s mens du redigerte (for %s Minutter siden). Kunne derfor ikke lagres.',
...
### ../db/db.inc.php   ###
'Database exception. Please read %s next steps on database errors.%s' => 'Database feil. Vennligst les %s neste steg om db feil.',
...
'The changed profile <b>does not affect existing project roles</b>! Those has to be adjusted inside the projects.' => 'Den endrete profilen <b> påvirker ikke eksisterende prosjekt roller</b>! Disse må justeres innenfor prosjektene.',
