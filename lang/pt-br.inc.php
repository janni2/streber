...
$g_lang_table = [
#--- top navigation tabs -------------------------------------------------------
'<span class=accesskey>H</span>ome' => '<span class=accesskey>P</span>rincipal',
'Go to your home. Alt-h / Option-h' => 'Ir para seu Espaço. Alt-h / Option-h',
'<span class=accesskey>P</span>rojects' => '<span class=accesskey>P</span>rojetos',
'Your projects. Alt-P / Option-P' => 'Seus Projetos. Alt-P / Option-P',
'People' => 'Usuários',
'Your related People' => 'Usuários de seu relacionamento',
'Companies' => 'Organizações',
'Your related Companies' => 'Organizações de seu relacionamento',
'Calendar' => 'Calendário',
'<span class=accesskey>S</span>earch:&nbsp;' => '<span class=accesskey>P</span>esquisa:&nbsp;',
'Click Tab for complex search or enter something and hit return. Use ALT-S as shortcut. Use `Search!` for `Good Luck`' => 'Clique em Tab para uma pesquisa complexa ou introduza algo e clique em <ENTER>. Use ALT-S para cortar caminho. Use `Pesquisa!` para `Boa Sorte`',

#--- header --------------------------------------------------------------
'Wiki+Help' => 'Wiki+Ajuda',
'Documentation and Discussion about this page' => 'Documentação e Discussão sobre esta página',
'This page requires java-script to be enabled. Please adjust your browser-settings.' => 'Esta página necessita que a java-script esteja habilidato. Por favor ajuste as suas configurações do browser.',
'you are' => 'Voce é',

'How this page looks for clients' => 'Aparência desta página para clientes',
...
'Company' => 'Organização',
'Project' => 'Projeto',
'Select lines to use functions at end of list' => 'Selecione linhas para usar funções no fim da lista',
'Priority' => 'Prioridade',
'Edit' => 'Edtar',
'Log hours for a project' => 'Hora conectadas a um projeto',
'Create new project' => 'Criar novo projeto',
'You have no open tasks' => 'Voce não tem tarefas abertas',
'Open tasks' => 'Tarefas abertas',
'Task-Status' => 'Estado da Tarefa',
'Folder' => 'Pasta',
'Started' => 'Iniciada',
'Est.' => 'Est.',
'Estimated time in hours' => 'Tempo estimado em horas',
'status->Completed' => 'Estado->Completado',
'status->Approved' => 'Estado->Aprovado',
'Delete' => 'Elimidado',
'Log hours for select tasks' => 'Horas ligadas a determinadas tarefas',
'%s tasks with estimated %s hours of work' => '%s Tarefas com %s horas estimadas de trabalho',
...
'Intra' => 'Intra',
'Mail' => 'E-Mail',
' Hint: for already existing projects please edit those and adjust company-setting.' => ' Tip: para projetos existentes favor editar esses e ajuste a configuração da Organização..',
...
'Please consider that activating login-accounts might trigger security-issues.' => 'Favor considerar que ativando contas de acesso pode ativar problemas com a segurança.',
...
'<b>NOTE</b>: Some projects are hidden from your view. Please ask an administrator to adjust you rights to avoid double-creation of projects' => 'Alguns projetos são ocultos a sua visão. Por favor peça um administrador para ajustar seus direitos para evitar a criação dupla de projetos.',
...
'Add person as team-member to project' => 'Acrescentar a Usuários como membro de equipe para projetar',
