...
'Go to your home. Alt-h / Option-h' => 'Votre page de démarrage, Alt-h / Option-h',
'<span class=accesskey>P</span>rojects' => '<span class=accesskey>P</span>rojets',
'Your projects. Alt-P / Option-P' => 'Vos projets. Alt-P / Option-P',
'People' => 'Contacts',
'Your related People' => 'Vos relations',
'Companies' => 'Companies',
'Your related Companies' => 'Vos companies',
'Calendar' => 'Calendrier',
'<span class=accesskey>S</span>earch:&nbsp;' => '<span class=accesskey>R</span>echerche:&nbsp;',
'Click Tab for complex search or enter something and hit return. Use ALT-S as shortcut. Use `Search!` for `Good Luck`' => 'Clicker sur tabs pour une recherche étendue',

#--- header --------------------------------------------------------------
'Wiki+Help' => 'Wiki+Hilfe',
'Documentation and Discussion about this page' => 'Documentation et Discussion sur cette page',
'This page requires java-script to be enabled. Please adjust your browser-settings.' => 'Cette page requière l´activation des script java. Ajuster les paramètres du browser.',
'you are' => 'Actuellement connecté',

'How this page looks for clients' => 'Aperçu pour client',
...
'Company' => 'Companie',
'Project' => 'Projet',
'Select lines to use functions at end of list' => 'Sélectionner les lignes pour utiliser les fonctions',
'Priority' => 'Priorité',
'Edit' => 'Modifier',
'Log hours for a project' => 'Enregister heure pour un projet',
'Create new project' => 'Créer un nouveau projet',
'You have no open tasks' => 'Vous n´avez pas de tâche ouverte',
'Open tasks' => 'Tâches ouvertes',
'Task-Status' => 'Etat des tâches',
'Folder' => 'Dossier',
'Started' => 'Créé le',
'Est.' => 'Est.',
'Estimated time in hours' => 'Temps estimé en heure',
'status->Completed' => 'Etat->terminé',
'status->Approved' => 'Etat->approuvé',
'Delete' => 'Effacer',
'Log hours for select tasks' => 'Enregistrement heure pour la tâche',
'%s tasks with estimated %s hours of work' => '%s des tâches. %s heure de travail',
...
'Link People' => 'Personnes liées',
'List People' => 'Listes des contacts',
...
'Your related people' => 'Vos contacts',
'Rights' => 'Droits',
'People rights in this project' => 'Droits des contacts pour ce projet',
'Add team member' => 'Ajouter un participant',
...
'Add existing people to this company' => 'Ajouter des contacts existants dans cette companie',
'People' => 'Contacts',
...
'Intra' => 'Intra',
'Mail' => 'E-Mail',
' Hint: for already existing projects please edit those and adjust company-setting.' => ' Conseil: pour les projets existant, modifier dans les paramètres de la companie',
'no projects yet' => 'Pas encore de projet',
'link existing Person' => 'Lien sur contacts existant',
'create new' => 'Créer nouveau',
'no people related' => 'Pas de contacts en relation',
'Create another company after submit' => 'Créer une autre companie après validation',
'Edit %s' => 'Modifier %s',
'Add people employed or related' => 'Ajoutez les personnes employées ou en relation',
'No people selected...' => 'Pas de contacts sélectionné',
...
'All People' => 'Tous les contacts',
'no related people' => 'Aucun',
...
'Select some people to delete' => 'Sélectionner les contacts  supprimer',
'Adjust user-rights of %s' => 'Ajuster les droits d´accès de %s',
'Please consider that activating login-accounts might trigger security-issues.' => 'Please consider that activating login-accounts might trigger security-issues.',
...
'<b>NOTE</b>: Some projects are hidden from your view. Please ask an administrator to adjust you rights to avoid double-creation of projects' => '<b>NOTE</b>: Quelques projets sont cachés de votre vue.  Veuillez demander  un administrateur de vous ajuster des droits pour éviter la double-création des projets',
...
'Add person as team-member to project' => 'Ajouter un participant au projet',
...
'found no people to add' => 'Pas de contacts trouvé  ajouter',
'No people selected...' => 'Pas de contacts sélectionné',
...
'HINT: You turned task <b>%s</b> into a folder. Folders are shown in the task-folders list.' => 'Conseil: vous déplacez la tâche <b>%s</b> dans un dossier. Les dossiers sont montrés dans la liste dossier de tâches.',
...
'Failed to delete %s people' => 'la supression du contact %s a échouée',
'Moved %s people to trash' => 'Le contact %s est déplacé dans la corbeille',
...
'Select some people to edit' => 'Sélectionnez un contact  modifier',
...
'Found %s people' => '%s contacts trouvées',
...
'All People|page option' => 'Tous les contacts',
'People/Project Overview' => 'Contact/apercu projet',
'People|Pagetitle for person list' => 'Contacts',
...
'Create People|a user right' => 'Créer contact',
'Edit Presons|a user right' => 'Modifier contact',
'Delete People|a user right' => 'Effacer contact',
'View all People|a user right' => 'Voir tous les contacts',
...
### ../std/constant_names.inc   ###
'Edit People|a user right' => 'Modifier contact',
...
### ../pages/company.inc   ###
'related People' => 'Contacts en relation',
...
'Select some people to notify' => 'Sélectionner les contacts  notifiés',
'Failed to mail %s people' => 'Echec de l´envoi de mail aux contacts %s',
...
'Remove people from company' => 'Enlever des personnes des companies',
'List Employees' => 'Liste des employés',
'List Deleted People' => 'Liste des personnes supprimées',
...
'Contact People|Pagetitle for person list' => 'Personnes de contact',
...
'Found no people to add. Go to `People` to create some.' => 'Pas de personne trouvée',
...
'Other People|page option' => 'Autre contacts',
...
'Contact People|page option' => 'Contacts',
...
'Create & Edit People|a user right' => 'Créer et modifier les personnes',
