...
class ListBlockCol_EffortPersonAmountSalary extends ListBlockCol
{
    ...
    public function render_tr(&$obj, $style = '')
    {
        ...
        if ($person = Person::getVisibleById($obj->person)) {
            ...
            $sum_sal = Effort::getSumEfforts(['project' => $obj->project, 'person' => $person->id]);
            #}
            if ($sum_sal) {
...
class ListBlockCol_EffortPersonTaskCalculation extends ListBlockCol
{
    ...
    public function render_tr(&$obj, $style = '')
    {
        ...
        if ($effort_tasks = Effort::getEffortTasks(['project' => $obj->project, 'person' => $obj->person])) {
