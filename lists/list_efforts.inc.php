...
class ListBlockCol_EffortBilling extends ListBlockCol
{
    public $key = 'billing';
    ...
    {
        parent::__construct($args);
        $this->name = __('Billing', 'column header');
    }
    public function render_tr(&$obj, $style = '')
    {
        global $PH;
        ...
        if (isset($obj->billing)) {
            $str = $g_effort_billing_names[$obj->billing];
        }
        echo "<td><nobr>$str</nobr></td>";
    }
}
...
class ListBlockCol_EffortDate extends ListBlockCol
{
    ...
    public function render_tr(&$obj, $style = '')
    {
        ...
        echo "<td><nobr>$value</nobr></td>";   #@@@ note: nobr is a hack for firefox 1.0
    }
}
