...
class Block_DocuNavigation extends PageBlock
{
    ...
    private function initStructure()
    {
        ...
        ### with parents ###
        elseif ($parents = $this->current_task->getFolder()) {
    ...
    */
    private function printLink($t)
    {
        ...
        if ($t->category == TCATEGORY_FOLDER) {
            ...
            $page = 'taskViewAsDocu';
        } elseif ($this->current_task && $t->id == $this->current_task->id) {
            $style = 'current';
        }
